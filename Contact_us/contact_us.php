...
$sqlshop = "select name,address,tel,email,img_path,img_title,date_shop,datediff('$Date',date_shop)/365 as year from shop;";
...
<body class="js">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-12">
                        ...
                        <div class="logo"><br>
                            <a href="../Home"><img
                                    src="../../GAME_GADGET_shop/image/<?php echo $rowshop['img_title']; ?>"
    ...
    <div class="map" style="width: 100vw; position: relative; margin-left: -50vw; left: 50%; margin-bottom: 3em;">
        <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6720.042279554864!2d102.63345683919555!3d17.92737273409335!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31246954fbfd4f85%3A0xf637a7eb5a77d5c0!2sGAME%20GADGET!5e0!3m2!1sth!2sla!4v1625070011522!5m2!1sth!2sla"
    ...
    <div class="container font14">
        <div class="row" align="center">
            ...
            <div class="col-md-12">
                <label>ວັນສ້າງຕັ້ງຮ້ານ: <?php echo $rowshop['date_shop']; ?> ໄດ້
                    <?php echo number_format($rowshop['year']); ?> ປີ </label>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-6 col-12">
                        ...
                        <div class="single-footer about">
                            <div class="logo">
                                <a href="../Home"><img
                                        src="../../GAME_GADGET_shop/image/<?php echo $rowshop['img_path'] ?>"
                                        width="80px;" alt="#"></a>
                            </div>
                ...
                <div class="inner">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
							...
							?>
                                &nbsp;&nbsp;&nbsp; <img
                                    src="../../GAME_GADGET_shop/image/<?php echo $rowcredit['img_path'] ?>"
                                    width="30px;" alt="#">
                                <?php 
								}
							?>
