...
<div class="row">
    <div class="col-xs-12 col-sm-6">
        <form action="PDF-Employee" method="POST" id="form_pdf" target="_blank">
    ...
    <div class="col-xs-12 col-sm-6" align="right">
        <form action="Excel-Employee" method="POST" id="form_pdf" target="_blank">
