...
<body class="js">
    ...
    <div class="container font18" align="center" style="margin-top: 20px;">
        <form action="Register" method="POST" id="frmregister" class="needs-validation" novalidate>
            <h3>ລົງທະບຽນ</h3><br>
            <div class="row">
                <div class="col-xs-12 col-sm-6 form-group" align="left">
                    <label>ຊື່ຜູ້ໃຊ້<sup style="color: red;">*</sup></label>
                    <input type="text" name="cus_name" class="form-control" placeholder=" ຊື່ຜູ້ໃຊ້"
                ...
                <div class="col-xs-12 col-sm-6 form-group" align="left">
                    <label>ນາມສະກຸນ<sup style="color: red;">*</sup></label>
                ...
                <div class="col-xs-12 col-sm-6 form-group" align="left">
                    <label>ເພດ<sup style="color: red;">*</sup></label>
                ...
                <div class="col-xs-12 col-sm-6 form-group" align="left">
                    <label>ທີ່ຢູ່ປັດຈຸບັນ<sup style="color: red;">*</sup></label>
                ...
                <div class="col-xs-12 col-sm-6 form-group" align="left">
                    <label>ເບີໂທລະສັບ<sup style="color: red;">*</sup></label>
                ...
                <div class="col-xs-12 col-sm-6 form-group" align="left">
                    <label>ອີເມວ<sup style="color: red;">*</sup></label>
                ...
                <div class="col-xs-12 col-sm-6 form-group" align="left">
                    <label>ລະຫັດ<sup style="color: red;">*</sup></label>
                ...
                <div class="col-xs-12 col-sm-6 form-group" align="left">
                    <label>ຢືນຢັນລະຫັດ<sup style="color: red;">*</sup></label>
                    <input type="password" name="requetpass" class="form-control" placeholder=" Requet Password"
                        style="height: 50px;" required>
                    <div class="invalid-feedback">
                        ກະລຸນາຢືນຢັນລະຫັດ
                    </div>
                ...
                <div class="col-md-12 form-group">
                    <button type="submit" style="width: 100%;" name="btnRegister" class="btn"
                        onclick="">Register</button><br>
                </div>
            </div>
        </form>
    </div>
