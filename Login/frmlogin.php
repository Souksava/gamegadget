                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            <label>ຊື່ ແລະ ນາມສະກຸນ: <?php echo $_SESSION['cus_name'];?>  <?php echo $_SESSION['cus_surname'];?> ເພດ: <?php echo $_SESSION['gender'];?></label><br>
							<label>ທີ່ຢູ່: <?php echo $_SESSION['address'];?></label><br>
							<label>ເບີໂທລະສັບຕິດຕໍ່: <?php echo $_SESSION['tel'];?> What's app: <?php echo $_SESSION['tel_app'];?></label><br>
                        ...
                        <p class="card-text">
                            ...
                            <form action="../Check/Login" method="POST" id="formlogin">
                                <div class="col-md-12 form-group" align="left">
                                    <label>ອີເມວ</label>
                                    <input type="email" name="email" class="form-control" placeholder=" Email Address" style="height: 50px;">
                                </div>
                                <div class="col-md-12 form-group" align="left">
                                    <label>ລະຫັດ</label>
                                ...
                                <div class="col-md-12 form-group">
                                    <button type="submit" style="width: 100%;" name="btnSave" class="btn" onclick="">Login</button><br>
                                </div>
