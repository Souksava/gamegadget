            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-12">
                        ...
                        <div class="logo"><br>
                            <a href="../Home"><img
                                    src="http://backend.gamegadgetlao.com/image/<?php echo $rowshop['img_path']; ?>"
                                    style="margin-top: -40px;" alt="" width="60%"></a>
                        </div>
                        <!--/ End Logo -->
                        <!-- Search Form -->
                                    ...
                                    <ul class="shopping-list">
                                        ...
                                        <li>
                                            <a class="cart-img" href="#"><img
                                                    src="http://backend.gamegadgetlao.com/image/<?php echo $rowlistfb['img_path']; ?>"
            ...
            <div class="col mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                        <h3>ຂໍ້ມູນສ່ວນຕົວ</h3> <br>
                        <label>ຊື່ ແລະ ນາມສະກຸນ: <?php echo $_SESSION['cus_name'];?>
                            <?php echo $_SESSION['cus_surname'];?> ເພດ: <?php echo $_SESSION['gender'];?></label><br>
                        <label>ທີ່ຢູ່: <?php echo $_SESSION['address'];?></label><br>
                        <label>ເບີໂທລະສັບຕິດຕໍ່: <?php echo $_SESSION['tel'];?> What's app:
                            <?php echo $_SESSION['tel_app'];?></label><br>
            ...
            <div class="col mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                        <h5>ເຂົ້າສູ່ລະບົບ</h5>
                        <form action="../Check/Login" method="POST" id="formlogin" class="needs-validation" novalidate>
                            <div class="row" align="left">
                                <div class="col-md-12 form-group">
                                    <label>ອີເມວ</label>
                                    <input type="text" class="form-control" name="email" id="email" value=""
                                        style="height: 50px;" placeholder="ອີເມວ" required>
                                    <div class="invalid-feedback">
                                        ກະລຸນາປ້ອນອີເມວ
                                    </div>
                                </div>
                                <div class="col-md-12 form-group">
                                    <label for="" class="">ລະຫັດ</label>
                                    <input type="password" class="form-control" name="pass" placeholder="ລະຫັດ"
                                        id="pass" style="height: 50px;" value="" required>
                                    <div class="invalid-feedback">
                                        ກະລຸນາປ້ອນລະຫັດ
                                    </div>
                                </div>
                                <div class="col-md-12 form-group">
                                    <button type="submit" name="btnLogin" id="btnLogin" class="btn btn-outline-danger"
                        ...
                        <div class="col-md-12 form-group">
                            <p>or</p>
                            <label style="color: #1563BE;"><a href="Register">ສະມາຊິກໃໝ່ ລົງທະບຽນ</a></label>
                        </div>
                        </p>
                    </div>
                </div>
                ...
                <div class="inner">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
							...
							?>
                                &nbsp;&nbsp;&nbsp; <img
                                    src="http://backend.gamegadgetlao.com/image/<?php echo $rowcredit['img_path'] ?>"
                                    width="30px;" alt="#">
                                <?php 
                                }
