			...
			<div class="container">
				<div class="row">
					<div class="col-lg-2 col-md-2 col-12">
						<!-- Logo -->
                        <div class="logo">
							<a href="Home"><img src="../game_gadget_shop/image/<?php echo $rowshop['img_path']; ?>" alt="" width="100px"></a>
						</div>
						<!--/ End Logo -->
						<!-- Search Form -->
								...
								<ul class="main-category">
									...
									<li><a href="#"><img src="../game_gadget_shop/image/<?php echo $rowcate['img_path']; ?>" width="15px;" alt=""> <?php echo $rowcate['cate_name']; ?> <i class="fa fa-angle-right" aria-hidden="true"></i></a>
										<ul class="sub-category">
											...
											?>
											<li><a href="Search/Search?id=<?php echo $rowcatedetail['cated_name'] ?>"><?php echo $rowcatedetail['cated_name']; ?></a></li>
											<?php 
												}
											?>
										</ul>
						...
						<div class="single-product">
							<div class="product-img">
								<a href="Product/Productdetail?id=<?php echo $rowshow['pro_id']; ?>">
									<img class="default-img" src="../game_gadget_shop/image/<?php echo $rowshow['img_path']; ?>" style="width:300px;height:280px;" alt="">
									<img class="hover-img" src="../game_gadget_shop/image/<?php echo $rowshow['img_path']; ?>" style="width:300px;height:280px;" alt="">
									<span class="out-of-stock">ຫຼຸດ <?php echo number_format($rowshow['persen'],2); ?>%</span>
								</a>
								<div class="button-head">
									<div class="product-action-2">
										<a title="Add to cart" href="Basket/Basket?product=<?php echo $rowshow['pro_id']; ?>">ເພີ່ມລົງໃນກະຕ່າ</a>
									</div>
								</div>
							</div>
							<div class="product-content">
								
								<h3><a href="Product/Productdetail?id=<?php echo $rowshow['pro_id']; ?>"><?php echo $rowshow['cate_name']; ?> <?php echo $rowshow['brand_name']; ?> <?php echo $rowshow['pro_name']; ?> <br> <?php echo $rowshow['cated_name']; ?></a></h3>
												...
												<div class="single-product">
													<div class="product-img">
														<a href="Product/Productdetail?id=<?php echo $rowprobrand['pro_id']; ?>">
															<img class="default-img" src="../game_gadget_shop/image/<?php echo $rowprobrand['img_path']; ?>" style="width:300px;height:280px;" alt="#">
															<img class="hover-img" src="../game_gadget_shop/image/<?php echo $rowprobrand['img_path']; ?>" style="width:300px;height:280px;" alt="#">
															<?php 
						...
						<div class="single-product">
							<div class="product-img">
								<a href="Product/Productdetail?id=<?php echo $rowshow2['pro_id']; ?>">
									<img class="default-img" src="../game_gadget_shop/image/<?php echo $rowshow2['img_path']; ?>" style="width:300px;height:280px;" alt="">
									<img class="hover-img" src="../game_gadget_shop/image/<?php echo $rowshow2['img_path']; ?>" style="width:300px;height:280px;" alt="">
									<span class="out-of-stock">ມາແຮງ</span>
								</a>
								<div class="button-head">
									<div class="product-action-2">
										<a title="Add to cart" href="Basket/Basket?product=<?php echo $rowshow2['pro_id']; ?>">ເພີ່ມລົງໃນກະຕ່າ</a>
									</div>
								</div>
							</div>
							<div class="product-content">
								
								<h3><a href="Product/Productdetail?id=<?php echo $rowshow2['pro_id']; ?>"><?php echo $rowshow2['cate_name']; ?> <?php echo $rowshow2['brand_name']; ?> <?php echo $rowshow2['pro_name']; ?> <br> <?php echo $rowshow2['cated_name']; ?></a></h3>
								<div class="product-price"><br>
									<?php 
										if($promotion > 0){
									?>
						...
						?>
							<div class="col-lg-6 col-md-6 col-12">
								<div class="list-image overlay">
									<img src="../game_gadget_shop/image/<?php echo $rowsale['img_path']; ?>" style="width:230px;height:200px;" alt="">
									<a href="Basket/Basket?product=<?php echo $rowsale['pro_id']; ?>" class="buy"><i class="fa fa-shopping-bag"></i></a>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-12 no-padding">
								<div class="content">
									<h4 class="title"><a href="Product/Productdetail?id=<?php echo $rowsale['pro_id']; ?>"><?php echo $rowsale['cate_name']; ?> <?php echo $rowsale['brand_name']; ?>  </a></h4>
									<h4 class="title"><a href="Product/Productdetail?id=<?php echo $rowsale['pro_id']; ?>"><?php echo $rowsale['pro_name']; ?>  </a></h4>
									<h4 class="title"><a href="Product/Productdetail?id=<?php echo $rowsale['pro_id']; ?>"><?php echo $rowsale['cated_name']; ?> </a></h4>
				...
				<div class="col-lg-4 col-md-6 col-12">
					...
					<div class="single-list">
						...
						?>
							<div class="col-lg-6 col-md-6 col-12">
								<div class="list-image overlay">
									<img src="../game_gadget_shop/image/<?php echo $rowbest['img_path']; ?>" style="width:230px;height:200px;" alt="">
									<a href="Basket/Baske?product=<?php echo $rowbest['pro_id']; ?>" class="buy"><i class="fa fa-shopping-bag"></i></a>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-12 no-padding">
								<div class="content">
									<h4 class="title"><a href="Product/Productdetail?id=<?php echo $rowbest['pro_id']; ?>"><?php echo $rowbest['cate_name']; ?> <?php echo $rowbest['brand_name']; ?>  </a></h4>
									<h4 class="title"><a href="Product/Productdetail?id=<?php echo $rowbest['pro_id']; ?>"><?php echo $rowbest['pro_name']; ?>  </a></h4>
									<h4 class="title"><a href="Product/Productdetail?id=<?php echo $rowbest['pro_id']; ?>"><?php echo $rowbest['cated_name']; ?> </a></h4>
				...
				<div class="col-lg-4 col-md-6 col-12">
					...
					<div class="single-list">
						...
						?>
							<div class="col-lg-6 col-md-6 col-12">
								<div class="list-image overlay">
									<img src="../game_gadget_shop/image/<?php echo $rowtop['img_path']; ?>" style="width:230px;height:200px;" alt="">
									<a href="Basket/Basket?product=<?php echo $rowtop['pro_id']; ?>" class="buy"><i class="fa fa-shopping-bag"></i></a>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-12 no-padding">
								<div class="content">
									<h4 class="title"><a href="Product/Productdetail?id=<?php echo $rowtop['pro_id']; ?>"><?php echo $rowtop['cate_name']; ?> <?php echo $rowtop['brand_name']; ?>  </a></h4>
									<h4 class="title"><a href="Product/Productdetail?id=<?php echo $rowtop['pro_id']; ?>"><?php echo $rowtop['pro_name']; ?>  </a></h4>
									<h4 class="title"><a href="Product/Productdetail?id=<?php echo $rowtop['pro_id']; ?>"><?php echo $rowtop['cated_name']; ?> </a></h4>
				...
				<div class="row">
					<div class="col-lg-5 col-md-6 col-12">
						...
						<div class="single-footer about">
							<div class="logo">
								<a href="Home"><img src="../game_gadget_shop/image/<?php echo $rowshop['img_title'] ?>" width="80px;" alt="#"></a>
							</div>
